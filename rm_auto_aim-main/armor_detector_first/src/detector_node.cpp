...
: Node("armor_detector", options)
{
  ...
  marker_pub_ =
    this->create_publisher<visualization_msgs::msg::MarkerArray>("/detector/marker_first", 10);
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  // Init classifier
  auto pkg_path = ament_index_cpp::get_package_share_directory("armor_detector_first");
...
void ArmorDetectorNode::createDebugPublishers()
{
  ...
  result_img_pub_ = image_transport::create_publisher(this, "/detector_first/result_img");
}
